...
export type gsspCallbackWithRQ<T = any> = (
  qr_client: QueryClient,
  ctx: GetServerSidePropsContext
) => Promise<GetServerSidePropsResult<PagePropsWithRQ & T>>;
 ...
 */
export const gsspWithRq =
  (fn: gsspCallbackWithRQ) => (ctx: GetServerSidePropsContext) =>
    fn(new QueryClient(), ctx);
